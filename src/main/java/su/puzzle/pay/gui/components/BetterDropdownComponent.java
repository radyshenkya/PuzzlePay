...
public class BetterDropdownComponent extends FlowLayout {
    ...
    protected static class Divider extends BaseComponent implements BetterDropdownComponent.ResizeableComponent {
    ...
    protected static class Checkbox extends BetterDropdownComponent.Button {
